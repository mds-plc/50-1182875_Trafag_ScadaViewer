...
// Helpers
// -----------------------------------------------------------------------
const Wrapper = ({ children }) => (_jsx(LangProvider, { children: _jsx(MemoryRouter, { children: children }) }));
...
describe('FileTable', () => {
    it('shows "no files" message when files list is empty', () => {
        render(_jsx(Wrapper, { children: _jsx(FileTable, { ...DEFAULT_PROPS }) }));
        expect(screen.getByText('No files in local storage')).toBeInTheDocument();
    });
    it('displays file switch_name and record_count badge', () => {
        render(_jsx(Wrapper, { children: _jsx(FileTable, { ...DEFAULT_PROPS, files: [makeFile()], total: 1 }) }));
    ...
    it('clicking production row calls onExpandToggle with file_id', () => {
        ...
        const { container } = render(_jsx(Wrapper, { children: _jsx(FileTable, { ...DEFAULT_PROPS, files: [makeFile()], total: 1, onExpandToggle: onExpandToggle }) }));
    ...
    it('clicking testing row navigates to /chart with type=testing', () => {
        const { container } = render(_jsx(Wrapper, { children: _jsx(FileTable, { ...DEFAULT_PROPS, files: [makeFile({ type: 'testing', order_id: null })], total: 1, dataType: "testing" }) }));
        fireEvent.click(container.querySelector('.db-row'));
    ...
    it('clicking Delete button calls onDeleteRequest with the file', () => {
        ...
        const file = makeFile();
        render(_jsx(Wrapper, { children: _jsx(FileTable, { ...DEFAULT_PROPS, files: [file], total: 1, onDeleteRequest: onDeleteRequest }) }));
    ...
    it('clicking Download button calls onDownload with the file', () => {
        ...
        const file = makeFile();
        render(_jsx(Wrapper, { children: _jsx(FileTable, { ...DEFAULT_PROPS, files: [file], total: 1, onDownload: onDownload }) }));
    ...
    it('production file has "Show records" expand button', () => {
        render(_jsx(Wrapper, { children: _jsx(FileTable, { ...DEFAULT_PROPS, files: [makeFile()], total: 1, dataType: "production" }) }));
    ...
    it('sync badge shows "Synced" for done_remote and "Local" for done_local', () => {
        render(_jsx(Wrapper, { children: _jsx(FileTable, { ...DEFAULT_PROPS, files: [
    ...
    it('renders Pagination component when pages > 1', () => {
        const { container } = render(_jsx(Wrapper, { children: _jsx(FileTable, { ...DEFAULT_PROPS, files: [makeFile({ file_id: 'A_DONE.csv' }), makeFile({ file_id: 'B_DONE.csv' })], total: 2, pages: 2, page: 1 }) }));
