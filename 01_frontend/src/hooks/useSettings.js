...
export function useSettings() {
    const [perPage, setPerPageState] = useState(() => Number(localStorage.getItem(PER_PAGE_KEY)) || 50);
    const [refreshMs, setRefreshMsState] = useState(() => Number(localStorage.getItem(REFRESH_MS_KEY)) || 30000);
