 ...
 */
export function PlcProvider({ children }) {
    ...
    return (_jsx(PlcContext.Provider, { value: { status, connected, adsConnected }, children: children }));
}
/**
...
export function usePlc() {
    ...
    if (!ctx)
        throw new Error('usePlc must be used inside PlcProvider');
    return ctx;
}
